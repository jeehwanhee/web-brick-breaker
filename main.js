...
const skillExplain = [
	"1초 동안 아래에 베리어를 생성하여 공이 나가는 것을 막습니다.",
	"스킬 사용 후, 처음 공이 바에 튕길 시 공 5개가 추가됩니다.",
	"3초 동안 모든 투사체의 속도가 느려집니다.",
	"3초 동안 바의 이동속도가 증가합니다.",
	"스킬 사용 후, 처음 공이 바에 튕길 시 블록과 바를 관통하는 공 2개를 발사합니다.",
	"스킬 사용 후, 처음 공이 블럭을 타격할 때 주변 블록을 공격하는 변개가 내립니다.",
	"스킬 사용 후, 처음 공이 블럭을 타격할 때 일정시간 동안 지속 데미지를 입힙니다.",
	"1초 동안 방어막을 생성하여 보스의 공격을 튕겨내어 반격합니다."
];
